...
import { qtyDecrementer, qtyIncrementer } from "../State Manager/reducer";
...
export default function ItemsPart() {
    ...
    return <div style={{ padding: "25px", borderRight: "1px solid lightgrey", overflow: "auto", flexWrap: "wrap", width: "70%", height: "100%" }}>
        {
                    ...
                    <div key={index} style={{ marginBottom: "30px", borderTop: "1px solid lightgrey", padding: "10px" }} className="d-flex flex-column align-items-start">
                        <div style={{ display: "flex" }} className="w-100" >
                            ...
                            <div style={{ width: "100%" }}>
                                ...
                                <div style={{ display: "flex", alignItems: "center", justifyContent: "flex-end" }} >
                                    <button style={{ fontSize: "18px", color: "#000", display: "flex", alignItems: "center", justifyContent: "center", cursor: !(items.quantity > 0) ? "not-allowed" : "pointer", height: "20px", width: "20px", background: "none", border: "1px solid #000" }} disabled={!(items.quantity > 0)} 
                                        onClick={() => dispatch(qtyDecrementer(items.id))} >-</button>
                                    ...
                                    <button style={{ fontSize: "18px", color: "#000", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", height: "20px", width: "20px", background: "none", border: "1px solid #000" }} 
                                        onClick={() => dispatch(qtyIncrementer(items.id))} >+</button>
                                </div>
                            </div>
                        </div>
                    </div>
