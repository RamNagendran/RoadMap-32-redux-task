            ...
            <div style={{ marginTop: "10px", background: "rgb(240 240 240)", height: "30%", overflow: "auto" }} >
                {
                    cartItems.map((items, index) => {
                        return (
                            <div key={index} style={{ display: items.quantity === 0 ? "none" : "flex", alignItems: "center", justifyContent: "space-between", width: "100%", fontSize: "14px", color: "#000", margin: "10px 0px" }} >
                                <div>
