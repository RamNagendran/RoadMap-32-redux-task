...
export const cartItemsSlice = createSlice({
    name: 'CartItemsSlice',
    initialState : initialState.cartItems,
    reducers: {
        qtyIncrementer: (state, action) => {
...
export const { qtyIncrementer, qtyDecrementer } = cartItemsSlice.actions
